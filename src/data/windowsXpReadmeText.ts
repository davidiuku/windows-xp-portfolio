export const windowsXpReadmeText = `Windows XP Portfolio

An interactive Windows XP-inspired developer portfolio built with React,
...
It is designed as a developer portfolio where users can explore resume content,
project folders, links, images, and downloadable files through a familiar
desktop-style interface.

The project focuses on recreating core desktop interactions, including draggable
icons, selectable items, openable windows, taskbar behavior, File Explorer-style
folders, and Notepad-style text files.
...
• Openable, draggable, and resizable windows
...
• Image viewer polish to match Windows Picture and Fax Viewer
...
https://github.com/davidiuku/windows-xp-portfolio`;
